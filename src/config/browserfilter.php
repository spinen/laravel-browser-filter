...
return [
    ...
    */
    ...
    | goes device -> browser -> version.
    |
    | The device string can be "Mobile", "Other", or "Tablet" as defined by
    | UAParser\Parser. You can define an array of specific browser names that
    | you are targeting or use "*" to block all browsers of that device type.
    |
    | At the final level, you can define an array of comparison operators
    | to use for that specific browser or you can use a "*" to block all
    | versions of that browser.
    |
    | We are using php's version_compare function...
    |
